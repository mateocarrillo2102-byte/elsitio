    ...
    <main class="main-content">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <?php while($row = mysqli_fetch_assoc($resultado_pedidos)): ?>
                    <tr>
                        <td><?= $row['id_pedido'] ?></td>
                        ...
                        <td>
                            <a href="ver_pedido.php?id=<?= $row['id_pedido'] ?>" class="btn btn-primary btn-sm">Ver</a>
                            <a href="pedidos.php?eliminar=<?= $row['id_pedido'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar este pedido?')">Eliminar</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
